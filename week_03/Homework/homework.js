/* Bar Chart for Library Visits by Neighborhood*/

d3.csv("library_visits_jan22.csv").then(data => { // arrow function used within promise 
    ...
    const height = 500,
          width = 800,
          margin = ({ top: 25, right: 30, bottom: 35, left: 50 }); // fixing dimensions of the svg 
    ...
    let bar = svg.selectAll(".bar") // create bar groups
        .append("g")
        .data(data) // adding data to the bars 
        .join("g")
        .attr("class", "bar");
    ...
    bar.append('text') // add labels
        ...
        .attr('y', d => y(d.num) + 15)
        .attr('text-anchor', 'middle') // centering the text labels 
        .style('fill', 'white'); // style of the text 
